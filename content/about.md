...
I am an experienced Environmental Scientist with over 20 years of academic and professional expertise in environmental modeling, soil erosion, hydrology, agroecosystem modeling, climate change impact analysis, and stormwater modeling. My expertise lies in analyzing, interpreting, and communicating complex environmental and agricultural science problems—including hydrologic flow-path modeling, sediment and nutrient transport, and soil-erosion hotspot identification—using advanced numerical models, machine learning, artificial intelligence, statistical analysis, and geospatial methods.
...
- Hydrological and hydraulic Modeling (SWAT/SWAT+, SWMM, HPC)
- Hydroinformatics and Machine Learning (Support Vector Regression, Wavelet Analysis, Python, R, HPC)
- Climate Change Impact on Agriculture (WEPP, CMIP, GCM, CLIGEN)
- Urban Stormwater Management (SWMM, PCSWMM)
- GIS and Remote Sensing (ArcGIS, DEM Analysis, ERDAS, ENVI, Google Earth Engine)
- Research Funding, Grant Writing, and Interdisciplinary Collaboration
- Innovative Teaching and Curriculum Development

### Communication and collaboration

- Strong experience in multi-agency collaborations (EPA, USDA, DHS, USCG)
- Experienced proposal writer for funding support
- Development of Quality Assurance Project Plans (QAPP)
- Excellent oral and written communication skills
- Experienced in working in an international environment and with different federal agencies
...
Published 50+ articles in peer-reviewed journals and presented research at 20+ national and international conferences.

### Field and laboratory work

- Field soil and water sampling design and survey; soil physical and chemistry analysis and instrumentation.
- River and lake water quality sampling and monitoring in Poyang Lake, Jiangxi, China.
- Artificial rainfall experiments: indoor rill erosion with 3D laser scanning at the Yangling station, Shaanxi, China, and the NSERL, USDA, IN.
- Land-use and land-cover (LULC) field investigations, aerial photographic, and satellite virtual image interpretation of the Yangou watershed, Shaanxi, China.
...
[Introduction to the Institute of Mountain Hazards and Environment](http://english.imde.cas.cn/)
...
- Completion Certificate for Prompt Engineering for ChatGPT, verifying successful completion of Vanderbilt University’s course on Coursera
- Certificate of Service as Guest Editor of the special title “Tillage Systems Impact Soil Structure and Cover Crop” for MDPI *Land*, 2022
- Certificate of Completion for 6 hours of *Statistics for Business Analytics and Data Science A-Z*, issued by Udemy on July 16, 2020
- Certificate of Completion for 18 hours of *Data Science and Machine Learning Bootcamp with R*, issued by Udemy on June 2, 2020
- Certificate of Completion for 10.5 hours of *R Programming A-Z: R for Data Science with Real Exercises*, issued by Udemy on July 31, 2018
- Certificate of Completion for 9.5 hours of *Automate the Boring Stuff with Python Programming*, issued by Udemy on September 18, 2018
- Certificate of Completion for 6 hours of *R Programming: Advanced Analytics in R for Data Science*, issued by Udemy on July 30, 2018
- Certificate of Achievement for outstanding performance in Advanced English as a Second Language, issued by Lafayette Adult Resource Academy on June 24, 2015

### Honors and awards

- 2022–2024: EPA 24-hour Time Off “S” award
- 2017: NRC Research Associateship Award
- 2012: Computer Software Copyright Certificate
- 2011: The National Youth Natural Science Foundation
- 2011: Teaching Exemplar Nomination, Nanjing University of Posts and Telecommunications
- 2011: Outstanding Instructor, ESRI Cup Chinese University Student GIS Project Competition
- 2010: Young Teacher Excellence Award, Nanjing University of Posts and Telecommunications
- 2009: China Postdoctoral Science Foundation, 46th grant program
- 2008: Excellent Instructor, SuperMap Cup Chinese University Student GIS Project Competition
- 2004: Western Excellent Student Award, Institute of Mountain Hazards and Environment, CAS

### Memberships

- 2015–2016: Member, Association of American Geographers
