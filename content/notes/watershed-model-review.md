+++
title = "Review Paper: Review of Watershed-Scale Water Quality and Nonpoint Source Pollution Models"
description = "A review of 14 watershed-scale water-quality and nonpoint-source pollution models and model-selection criteria."
...
Offers a comprehensive review of existing watershed and water quality models/tools relevant to nutrient loading, namely nitrogen, phosphorus, TSS, and their environmental fate and transport. The goal is to assist watershed managers in selecting appropriate tools for hydrologic assessment, nutrient management, policy development, and TMDL (Total Maximum Daily Load) analysis. 

## Model Classification

The report examines 14 widely used models, grouped by complexity and application. 

Simple Models: Quick screening tools with minimal data needs—e.g., L-THIA, N‑SPECT/OpenNSPECT.

Medium Complexity Models: Semi-distributed tools with moderate input/calibration needs—e.g., GWLF, LSPC, SLAMM.

Complex Models: Physically based, requiring detailed data and calibration—e.g., AGNPS/AnnAGNPS, SWAT, SWMM, HSPF.

Modeling Systems: Integrated platforms combining multiple tools—e.g., AGWA, BASINS, WMS.
...
**Keywords:** watershed modeling; water quality; nonpoint source pollution; model selection; uncertainty analysis
