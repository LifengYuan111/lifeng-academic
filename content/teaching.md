...
In more theoretical courses such as Digital Elevation Models, I enriched the curriculum with insights from my own research. This gave students exposure to advanced analytical tools such as topographic-attribute extraction and flow-direction modeling, and invited them to engage critically with the material. Their feedback and perspectives contributed meaningfully to both my teaching and ongoing research, creating a reciprocal learning environment.
...
| :--- | :---: | :---: | :--- |
| Xingfei Liu | 3 | 2013 | [A cellular automata model for the process of rill erosion (2012)](https://zgstbckx.xml-journal.net/en/article/id/9779?viewType=citedby-info) |
...
At the core of my teaching is a belief in empowering students to become lifelong learners and critical thinkers. My approach is guided by four key principles:

1. **Knowledge Transfer** — Delivering clear, foundational instruction in core theories and technical skills.
2. **Inspiring Enthusiasm** — Creating engaging, relevant, and curiosity-driven learning experiences.
3. **Guidance and Support** — Providing mentorship that respects individual challenges while promoting independent thinking.
4. **Community Impact** — Equipping students to apply their knowledge in ways that benefit society and the environment.

With extensive teaching experience, innovative course design, and a strong research foundation, I am well prepared to contribute meaningfully to an academic community. I am passionate about nurturing future professionals in geospatial science and environmental modeling, and I look forward to collaborating with faculty and students to foster educational excellence.

## Teaching qualifications

### Associate Professor Qualification Certification
